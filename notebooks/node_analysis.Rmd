...
Here, again the RI model seems to perform best, although again not the arcsine-transformed one. We now reiterate Moran's I for the residuals.
...
```{r}
tab_model(fit_ch_allvac_either_ri, fit_ch_novac_either_ri, fit_rh_anc_pv_ri, fit_rh_anc_pvskill_ri, fit_fp_know_mod_ri, fit_fp_message_noneof3_ri, fit_nt_bf_ever_ri)
```
