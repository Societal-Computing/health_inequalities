...
# 	dv_help_phy_sex_any	"Sources of help sought for physical or sexual violence among women who sought help"# 	dv_help_fam 		    "Source of help: own family"
...
# //Ever
IRdata <- IRdata %>%
  mutate(dv_phy_sex_all =
           case_when(
             dv_phy==1 & dv_sex==1 ~ 1 ,
             v044==1  ~ 0 )) %>% 
  set_value_labels(dv_phy_sex_all = c("Yes" = 1, "No"=0)) %>%
  set_variable_labels(dv_phy_sex_all = "Ever experienced physical and sexual violence")
...
DVdata <- IRdata %>% 
  select(caseid,
         ...
         v190,
         	...
         	dv_sex,#				  "Ever experienced sexual violence"
         	dv_sex_12m,#		  "Experienced sexual violence in the past 12 months"
         	dv_sex_age_10,#		  "Specific age experienced sexual violence"
         dv_sex_age_12,#		  "Specific age experienced sexual violence"
         dv_sex_age_15,#		  "Specific age experienced sexual violence"
         dv_sex_age_18,#		  "Specific age experienced sexual violence"
         	dv_phy_only,#	  "Experienced physical violence only"
         	dv_sex_only,#		  "Experienced sexual violence only"
         	dv_phy_sex_all,#  "Experienced physical and sexual violence"
         	dv_phy_sex_any,#	"Experienced physical or sexual violence"
