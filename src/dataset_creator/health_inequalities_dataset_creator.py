...
class Health_Inequalities_DataCreator:
    ...
    def __init__(self, covariates_dataset_path, dhs_dataset_path, lmic_shapefile_path, sci_dataset_path,
    ...
    def main(self):
        ...
        lmic_sci_covariates_dhs_afro_hdi = lmic_sci_covariates_dhs_afro.drop_duplicates()

        geometries_cols = ['GID_1', 'geometry']
        geometries = lmic_sci_covariates_dhs_afro_hdi[geometries_cols]
        variables = lmic_sci_covariates_dhs_afro_hdi.loc[:,
                    ~lmic_sci_covariates_dhs_afro_hdi.columns.isin(['geometry'])]
